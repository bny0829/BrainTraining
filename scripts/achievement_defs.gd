...
static func all_defs() -> Array:
	return [
		...
		{"id": "t2048_512", "name": "小有所成", "desc": "在 2048 中合成 512",
			"conds": [{"section": "game2048_stats", "key": "best_tile", "min": 512}]},
		{"id": "t2048_win", "name": "2048！", "desc": "合成傳說中的 2048 磚塊",
			"conds": [{"section": "game2048_stats", "key": "best_tile", "min": 2048}]},
		{"id": "solitaire_first", "name": "接龍首勝", "desc": "第一次完成接龍",
			"conds": [{"section": "solitaire_stats", "key": "won", "min": 1}]},
		{"id": "solitaire_10", "name": "接龍老手", "desc": "完成 10 局接龍",
			"conds": [{"section": "solitaire_stats", "key": "won", "min": 10}]},
		{"id": "freecell_first", "name": "新接龍首勝", "desc": "第一次完成新接龍",
			"conds": [{"section": "freecell_stats", "key": "won", "min": 1}]},
		{"id": "freecell_10", "name": "空格大師", "desc": "完成 10 局新接龍",
			"conds": [{"section": "freecell_stats", "key": "won", "min": 10}]},
